...
public class Pc_fragment_nuevos extends Fragment {
    ...
    private void mostrarUsuariosMnt(){
        Call<List<Ticket>> call = ApiClient.getClient().create(IApiTicket.class).getTicketsNuevos();
        call.enqueue(new Callback<List<Ticket>>() {
            ...
            public void onResponse(Call<List<Ticket>> call, Response<List<Ticket>> response) {
                if(response.isSuccessful()){
                    ...
                    adapter = new AdapterTickets(ticketNuevosList, Pc_fragment_nuevos.this.getContext(), new AdapterTickets.OnItemClickListener() {
                        @Override
